...
export default function AddFarmer() {
  ...
  return (
    <div className="p-8 mx-30 ">
      <h1 className="text-4xl font-bold mb-6">Add a Farmer</h1>
      ...
      <div className="flex gap-6 flex-wrap mx-30">
          ...
          <div className="flex gap-4 mb-6">
            ...
            <div className="flex items-end">
              <button
                ...
                className="bg-green-700 text-white rounded px-6 py-2 hover:bg-green-800 whitespace-nowrap"
              >
                + Add Farm
              </button>
            </div>
        ...
        {/* Farm Form */}
        {showFarmForm && (
          <div className="w-[300px] mt-50 border rounded p-4 bg-white shadow-md relative ">
            {/* Close Button */}
            <button
              className="absolute top-1 right-2 text-gray-600 hover:text-red-600 text-[30px] cursor-pointer"
            ...
            <div className="mb-4">
              <label className="mb-1 text-sm font-medium block">Farm Name (if exists)</label>
              <input type="text" className=" rounded px-3 py-2 w-full bg-[#DFDEDE]" />
            </div>
            <div className="mb-4">
              <label className="mb-1 text-sm font-medium block">Location*</label>
              <input type="text" className=" rounded px-3 py-2 w-full bg-[#DFDEDE]" />
            </div>
            <div className="mb-4">
              <label className="mb-1 text-sm font-medium block">Crop Type*</label>
              <input type="text" className=" rounded px-3 py-2 w-full  bg-[#DFDEDE]" />
            </div>
            <button className="bg-green-700 text-white w-full py-2 rounded hover:bg-green-800">Save</button>
          </div>
        )}
      </div>
    </div>
